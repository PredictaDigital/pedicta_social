...
SECRET_KEY = 'django-insecure-84w)bmlha9s8x)a3gq^pjwxt_#a*05zu(03_g+#h_5931x-y8&'
...
ROOT_URLCONF = 'predicta_api.urls'
...
#     'default': {
#         'ENGINE': 'mssql',
#         'NAME': 'Predicta_Portal_DB',
#         'USER': 'Doodle_Developer',
#         'PASSWORD': 'EAFfs3_VmaGrwph=tKnb7C',
#         'HOST': 'predicta.database.windows.net',
#         'PORT': '1433',
#         'OPTIONS': {
